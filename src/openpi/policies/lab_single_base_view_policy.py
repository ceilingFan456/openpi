...
class LabInputs_single_base_view(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        match self.model_type:
            case _model.ModelType.PI0 | _model.ModelType.PI05:
                ...
                ## only use base image as the single view. 
...
@dataclasses.dataclass(frozen=True)
class LabOutputs_single_base_view(transforms.DataTransformFn):
    def __call__(self, data: dict) -> dict:
